...
All notable changes to `admingate/git-commit-checker` will be documented in this file.
...
- Fix output render on Windows admingate (https://github.com/admingate/git-commit-checker/pull/10)
